"""
슬다 자동화 v15.3 - Gemini 환경변수 수정 + make_rich_background Railway 호환 + 검은화면 방지
"""
...
if __name__ == "__main__":
    ...
    log(f"슬다 자동화 v15.3 시작! Gemini키:{len(GEMINI_KEYS)}개 Pexels:{'OK' if PEXELS_KEY else '없음'}", "ok")
    install_ffmpeg()
